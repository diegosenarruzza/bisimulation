...
class MessageMatchManager(MatchWithCandidatesManager):
    ...
    def _compatible_interactions_with(self, interaction):
        ...
        return [
            candidate_interaction for candidate_interaction in self.interactions._current_collection()
    ...
    def _message_candidates_from(self, compatible_messages):
        return [candidate for candidate in self.candidates._current_collection() if candidate in compatible_messages]
