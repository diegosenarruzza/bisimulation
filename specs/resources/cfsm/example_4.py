...
cfsm_1.add_transition_between('p0', 'p1', 'ConsumerAdder! add(int x)', x != 0)

cfsm_1.add_transition_between('p1', 'p2', 'ConsumerRemover! remove(int y)')
...
cfsm_2.add_transition_between('q1', 'q3', 'ClientBank! withdraw(int another_amount)')
cfsm_2.add_transition_between('q2', 'q3', 'ClientBank! withdraw(int another_amount)')
