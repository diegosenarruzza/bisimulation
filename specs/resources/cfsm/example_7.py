...
cfsm_1.add_transition_between('p1', 'p2', 'ServiceClient? success()', user == 'root')
cfsm_1.add_transition_between('p1', 'p2', 'ServiceClient? success()', user == 'user')
...
cfsm_2.add_transition_between('q1', 'q2', 'DbClient? ok()', username == 'root')
cfsm_2.add_transition_between('q1', 'q3', 'DbClient? ok()', username == 'user')
